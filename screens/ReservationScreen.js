    ...
    const presentLocalNotification = async (reservationDate) => {
        const sendNotification = () => {
            ...
            Notifications.scheduleNotificationAsync({
                content: {
                    title: 'Your Program Reservation Search',
            ...
            <View>
                ...
                <View style={styles.formRow}>
                    <Button
                        ...
                        color='#5637DD'
                        accessibilityLabel='Tap me to search for available spots to reserve'
                    />
                </View>
            </View>
            {/* </Animatable.View> */}
